...
new = """      {/* \u2500\u2500 Trial \u2014 fullscreen overlay, blocks all other interactions \u2500\u2500 */}
      {trial && trial.phase !== "resolved" && (
...
if old not in c:
    print("ERROR: old section not found in file")
    # Try to find partial match
    probe = 'vote(s) enregistr'
    idx = c.find(probe)
    print(f"probe '{probe}' at index:", idx)
    exit(1)
