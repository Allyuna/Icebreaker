...
# Read with surrogateescape to handle bad bytes
with open('app/at/hub/page.tsx', 'r', encoding='utf-8', errors='surrogateescape') as f:
    lines = f.readlines()
...
with open('app/at/hub/page.tsx', 'w', encoding='utf-8', errors='surrogateescape') as f:
...
if 'fixed inset-0 z-50' in verify and 'Trial resolved banner' in verify:
    ...
    print("New line count:", verify.count('\n'))
